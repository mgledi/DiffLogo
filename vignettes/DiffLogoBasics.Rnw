...
diffLogoFromPwm(pwm1 = pwm1, pwm2 = pwm2, calculatePvalues = T, n1 = n1, n2 = n2)
...
diffLogoTable(PWMs = motifs_dna, sampleSizes = sampleSizes_dna, configuration = list("calculatePvalues"=T))
@
